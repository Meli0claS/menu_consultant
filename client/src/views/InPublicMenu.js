...
const InPublicMenu = () => {
    const { menuState: { menus }, showToast: { show, message, type }, getInPublicMenus, ratingMenu, setShowToast } = useContext(MenuContext);
    useEffect(() => getInPublicMenus(), [])
